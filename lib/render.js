...
function getContext(url, request, controllers) {
...
function render(url, filepath, request, controllers) {

    var response = promise();

    getContext(url, request, controllers).then(function(context, customPath) {
        
        if (customPath) {
            filepath = __dirname.replace('/node_modules/breadbox/lib', '/views/') + customPath;
        }
